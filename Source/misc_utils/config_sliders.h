...
public:
	...
	template< class T >
	void AddVariable(  T* variable, const std::string& name, const Interface_MetaData& metadata )
	{
	...
	template<>
	void AddVariable(  bool& variable,  const std::string& name, const Interface_MetaData& metadata   )
	{
	...
	template<>
	void AddVariable( std::string& variable, const std::string& name, const Interface_MetaData& metadata )
	{
		SimpleTextbox* textbox = CreateTextbox( name, variable );
		
		if( metadata.type == Interface_MetaData::TYPE_FILE ) {
	...
	IConfigSlidersListener* GetListener() { return mListener; }
